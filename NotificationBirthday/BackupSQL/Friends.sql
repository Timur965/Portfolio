...
--
-- Name: subscriptions subscriptions_subscribed_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT subscriptions_subscribed_id_fkey FOREIGN KEY (subscribed_id) REFERENCES public.users(id);
